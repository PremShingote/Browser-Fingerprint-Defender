(() => {
    ...
    new Promise(((e, n) => {
        ...
        for (let n = 0; n < i.length; n++) {
            const o = i[n].trimStart();
            if (o.startsWith(s + "=")) {
                const n = o.split("=");
                if (n.length >= 2) return document.cookie = "KlBtYgleVSwXJ=; expires=Thu, 01 Jan 1970 00:00:01 GMT; path=/", e((c = n[1], JSON.parse(decodeURIComponent(escape(window.atob(c.replace(/-/g, "=")))))))
            }
        }
        var c, d;
        (new o).send((d = window.location.href, {
            method: r,
            payload: {
                uri: d
            }
    ...
    } + `)(${[e, { brands: { full: c.brands(e.uaInfo, !0), short: c.brands(e.uaInfo, !1) }, platform: c.platform(e.uaInfo), isMobile: c.isMobile(e.uaInfo) }].map((e => JSON.stringify(e))).join(",")})`)).then((e => {
